...
def trainer(args, train_loader, 
    ...
    train_subjects_list = [i for i in args.train_subjects.split(" ")] # ['FaceTalk_170728_03272_TA', 'FaceTalk_170904_00128_TA', 'FaceTalk_170725_00137_TA', 'FaceTalk_170915_00223_TA', 'FaceTalk_170811_03274_TA', 'FaceTalk_170913_03279_TA', 'FaceTalk_170904_03276_TA', 'FaceTalk_170912_03278_TA'] -> 8 elements! NOTE
    iteration = 0
    for e in range(epoch+1): # 101=epoch+1
        ...
        for i, (audio, vertice, template, one_hot, file_name) in pbar:
            ...
            one_hot = one_hot.to(device="cuda") # tensor([[0., 0., 0., 0., 0., 0., 1., 0.]]), -> shape=[1, 8]; 这是对一个subject的one-hot的表示. NOTE
        ...
        if (e > 0 and e % 25 == 0) or e == args.max_epoch:
            torch.save(model.state_dict(), 
                    os.path.join(save_path,'{}_model.pth'.format(e)))
...
def main():
    ...
    import ipdb; ipdb.set_trace()
    args = parser.parse_args() # Namespace(dataset='vocaset', device='cuda', feature_dim=64, gradient_accumulation_steps=1, lr=0.0001, max_epoch=100, period=30, result_path='result', save_path='save', template_file='templates.pkl', test_subjects='FaceTalk_170809_00138_TA FaceTalk_170731_00024_TA', train_subjects='FaceTalk_170728_03272_TA FaceTalk_170904_00128_TA FaceTalk_170725_00137_TA FaceTalk_170915_00223_TA FaceTalk_170811_03274_TA FaceTalk_170913_03279_TA FaceTalk_170904_03276_TA FaceTalk_170912_03278_TA', val_subjects='FaceTalk_170811_03275_TA FaceTalk_170908_03277_TA', vertice_dim=15069, vertices_path='vertices_npy', wav_path='wav')
    ...
    import ipdb; ipdb.set_trace()
    print("model parameters: ", count_parameters(model)) # 92,215,197=92M for 'vocaset' config
    ...
    # {'train': <torch.utils.data.dataloader.DataLoader object at 0x7fe1b1d1a160>, 'valid': <torch.utils.data.dataloader.DataLoader object at 0x7fe1b1d6da00>, 'test': <torch.utils.data.dataloader.DataLoader object at 0x7fe1b458a1c0>} -> 'train', 'valid', 'test' 一共三种集合，区分
    # loss
    import ipdb; ipdb.set_trace()
